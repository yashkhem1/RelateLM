...
def get_bilingual_dictionary(bilingual,o1,o2,l1,l2,transliterate,trans_lang,choose_random=True):
    l1_l2_dict = {}
    l2_l1_dict = {}
    if transliterate:
        if trans_lang == 'l1':
...
if __name__ == "__main__":
    ...
    get_bilingual_dictionary(args.bilingual,args.o1,args.o2,args.l1,args.l2,args.transliterate,args.trans_lang)
